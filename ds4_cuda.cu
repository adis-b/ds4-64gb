...
/* CUDA path does not currently expose a "RAM-constrained" signal to the
 * scheduler; report 0 so callers fall through to their default behavior. */
extern "C" int ds4_gpu_model_is_ram_constrained(void) { return 0; }
